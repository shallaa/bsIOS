...
//경계선 스타일 
STR_CONST(kbsTextBorderStyleNone, "none")
STR_CONST(kbsTextBorderStyleLine, "line")
STR_CONST(kbsTextBorderStyleBezel, "bezel")
STR_CONST(kbsTextBorderStyleRoundedRect, "round-rect")

//clear 버튼이 나타날때 
STR_CONST(kbsTextFieldClearButtonNever, "never")
STR_CONST(kbsTextFieldClearButtonWhileEditing, "while")
STR_CONST(kbsTextFieldClearButtonUnlessEditing, "unless")
STR_CONST(kbsTextFieldClearButtonAlways, "always")

//대문자 처리
STR_CONST(kbsTextFieldCapitalizationNone, "none")
STR_CONST(kbsTextFieldCapitalizationWord, "word")
STR_CONST(kbsTextFieldCapitalizationSentence, "sentence")
STR_CONST(kbsTextFieldCapitalizationAll, "all")

//맞춤법 처리
STR_CONST(kbsTextFieldCorrectionDefault, "default");
STR_CONST(kbsTextFieldCorrectionYes, "yes");
STR_CONST(kbsTextFieldCorrectionNo, "no");

//키보드 모양
STR_CONST(kbsTextFieldKeyboardAppearanceDefault, "default");
STR_CONST(kbsTextFieldKeyboardAppearanceAlert, "alert");

//키보드 타입 
STR_CONST(kbsTextFieldKeyboardTypeDefault, "default");
STR_CONST(kbsTextFieldKeyboardTypeAlphabet, "alphabet");
STR_CONST(kbsTextFieldKeyboardTypeAscii, "ascii");
STR_CONST(kbsTextFieldKeyboardTypeNumberPunctuation, "number-punctuation");
STR_CONST(kbsTextFieldKeyboardTypeURL, "url");
STR_CONST(kbsTextFieldKeyboardTypeNumber, "number");
STR_CONST(kbsTextFieldKeyboardTypePhone, "phone");
STR_CONST(kbsTextFieldKeyboardTypeNamePhone, "name-phone");
STR_CONST(kbsTextFieldKeyboardTypeEmail, "email");
STR_CONST(kbsTextFieldKeyboardTypeDecimal, "decimal");
STR_CONST(kbsTextFieldKeyboardTypeTwitter, "twitter");

//키보드 리턴키 
STR_CONST(kbsTextFieldReturnKeyDefault, "default");
STR_CONST(kbsTextFieldReturnKeyDone, "done");
STR_CONST(kbsTextFieldReturnKeyGo, "go");
STR_CONST(kbsTextFieldReturnKeyGoogle, "google");
STR_CONST(kbsTextFieldReturnKeyJoin, "join");
STR_CONST(kbsTextFieldReturnKeyNext, "next");
STR_CONST(kbsTextFieldReturnKeyRoute, "route");
STR_CONST(kbsTextFieldReturnKeySearch, "search");
STR_CONST(kbsTextFieldReturnKeySend, "send");
STR_CONST(kbsTextFieldReturnKeyYahoo, "yahoo");
STR_CONST(kbsTextFieldReturnKeyEmergency, "emergency");
