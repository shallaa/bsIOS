...
-(void)ready {
    ...
    if( __bsSegment_keyValues == nil ) {
        __bsSegment_keyValues =
        @{ @"titles": @kbsSegmentTitles, @"selected-index": @kbsSegmentSelectedIndex };
    }
...
-(id)__g:(NSString*)key {
    ...
    switch ( num ) {
        ...
        case kbsSegmentSelectedIndex: value = @(segment_.selectedSegmentIndex); break;
    }
    return value;
}
