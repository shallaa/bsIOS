...
//Drag관련
-(void)__panWithDragStart:(BOOL)dragStart dragWillEnd:(BOOL)dragWillEnd dragEnd:(BOOL)dragEnd
          decelerateStart:(BOOL)decelerateStart decelerateEnd:(BOOL)decelerateEnd {
